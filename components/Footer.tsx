...
export function Footer() {
  ...
  return (
    <footer className="border-t border-white/10 bg-canvas-dark text-white">
      <div className="container grid gap-10 py-16 md:grid-cols-4">
        <div>
          ...
          <p className="mt-3 text-[12px] text-white/40">CNPJ {business.cnpj}</p>
          {business.crc && (
            <p className="text-[12px] text-white/40">CRC {business.crc}</p>
          )}
        </div>

        <nav aria-label="Rodapé">
          <h3 className="text-[13px] font-semibold tracking-ui text-white/45">
            Navegação
          </h3>
          ...
          <ul className="mt-4 space-y-2.5 text-[14px]">
            <li>
              <a
                ...
                className="inline-flex items-center gap-2 text-white/70 hover:text-gold"
              >
